...
class VendingMachine:
    ...
    def vend(self):
        if self.stock == 0:
            ...
            if self.purse > self.price:
                self.stock -= 1
                change = self.purse - self.price
                self.purse = 0
                return 'Here is your {0} and ${1} change.'.format(self.name, change)
            elif self.purse == self.price:
                self.stock -= 1
                self.purse = 0
                return 'Here is your {0}.'.format(self.name)
            else:
                return 'You must add ${0} more funds.'.format(self.price - self.purse)
    ...
    def add_funds(self, num):
        if self.stock == 0:
            ...
            self.purse += num
            return 'Current balance: ${0}'.format(self.purse)
